module.exports = {
  ...
  siteTitle: "Yessica Duque - Photographer & Food stylist", // Site title.
  siteTitleAlt: "Yessica Duque Photography & Food Stylist ", // Alternative site title for SEO.
  siteLogo: "/logos/logo-1024.png", // Logo used for SEO and manifest.
  siteUrl: "http://yessicaduque.com", // Domain of your website without pathPrefix.
  pathPrefix: "/", // Prefixes all links. For cases when deployed to example.github.io/gatsby-advanced-starter/.
  siteDescription: "Professional website from Yessica Duque about food styling, cooking and professional photography.", // Website description used for RSS feeds/meta description tag.
  ...
  userDescription:
    "Professional food stylist and photographer", // User description to display in the author segment.
  ...
  designedBy: {
    ...
    name: "The Branding Plug",
    url: "http://thebrandingplug.com/"
  },
